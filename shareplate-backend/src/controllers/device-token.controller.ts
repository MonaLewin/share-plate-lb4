...
export class DeviceTokenController {
    ...
    async create(
        ...
        const existingToken = await this.deviceTokenRepository.findOne({where: {deviceToken: deviceToken.deviceToken}});
        return existingToken ? existingToken : this.deviceTokenRepository.create(deviceToken);
    }
}